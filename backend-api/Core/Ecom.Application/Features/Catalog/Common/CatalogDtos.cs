...
public sealed record ProductListItemDto(Guid Id, string Slug, string Name, string? ShortDescription,
    ...
    decimal? FromPrice, string? CurrencyCode, bool HasEffectivePrice, CatalogAvailabilityStatus Availability,
    DateTime PublishedAt, string? Standard = null, string? UnitLabel = null);
...
public sealed record ProductDetailDto(Guid Id, string Slug, string Name, string? ShortDescription,
    ...
    IReadOnlyList<ProductVariantDto> Variants, bool HasEffectivePrice, CatalogAvailabilityStatus Availability,
    DateTime PublishedAt, string? Standard = null, string? UnitLabel = null);
...
public sealed record ProductVariantDto(Guid Id, string Sku, string Name, decimal Price, string CurrencyCode,
    PriceType PriceType, decimal? WeightGrams, CatalogAvailabilityStatus Availability,
    IReadOnlyList<VariantOptionValueDto> Options, string? UnitLabel = null);

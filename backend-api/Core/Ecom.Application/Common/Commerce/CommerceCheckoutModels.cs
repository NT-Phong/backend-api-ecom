...
public sealed record CheckoutQuote(IReadOnlyList<CheckoutLine> Lines, decimal SubtotalAmount,
    ...
    decimal DiscountAmount = 0, string? CouponCode = null, Guid? CouponId = null, Guid? PromotionId = null,
    string PackagingOption = CheckoutPackaging.Standard);
...
public sealed record LockedCouponPromotion(Coupon Coupon, Promotion? Promotion);
...
public enum CouponValidationMode { Quote, Redemption }

...
| API/codegraph | [FE Integration Guide (API, Codegraph & Flowgraph)](04-api/FE-INTEGRATION-SPEC.md), [API catalog](04-api/API-CATALOG.md), [Catalog Core + Discovery FE contract](04-api/CATALOG-CORE-DISCOVERY-FE-CONTRACT.md), [request/response examples](04-api/REQUEST-RESPONSE-EXAMPLES.md), [contract chung](04-api/API-CONVENTIONS.md), [request pipeline](06-codegraphs/REQUEST-PIPELINE.md), [E2E flows](06-codegraphs/COMMERCE-FLOWS.md), [implementation codegraphs](06-codegraphs/IMPLEMENTATION-CODEGRAPHS.md) |
